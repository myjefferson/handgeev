    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-4">
                ...
                <a href="#" class="social-icon text-slate-400 text-lg hover:text-primary-500 transition-colors" title="{{ __('footer.social.instagram') }}">
                    <i class="fab fa-instagram"></i>
                </a>
                <a href="#" class="social-icon text-slate-400 text-lg hover:text-primary-500 transition-colors" title="{{ __('footer.social.linkedin') }}">
