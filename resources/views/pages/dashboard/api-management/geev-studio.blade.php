        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 mb-6">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="main-tabs" role="tablist">
                    ...
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="api-consult-tab-btn" data-tab-target="api-consult" type="button" role="tab">
                            <i class="fas fa-code mr-2"></i>API Consult
                        </button>
                    </li>
            ...
            <div id="tab-content-container">
                ...
                <!-- Tab API Consult -->
                @include('components.tabs.geev-studio-api-consult')
    ...
    <script type="module">
        ...
        function copyToClipboard(text, message) {
            navigator.clipboard.writeText(text).then(function() {
                ...
                alertManager.show('Erro ao copiar', 'error');
            });
        }
        ...
        function copyShareLink() {
            ...
            alertManager.show('Link copiado!', 'success');
        }
