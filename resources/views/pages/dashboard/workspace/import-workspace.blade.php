    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
        ...
        <div class="mb-8">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Importe um workspace a partir de um arquivo JSON
            </p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                ...
                <p class="text-xs text-blue-600 dark:text-blue-400">
                    O arquivo deve estar no formato JSON exportado do HandGeev. 
                    Estrutura esperada: workspace → topics → fields com key_name como chave principal.
                </p>
            </div>
        ...
        <div class="mt-6 grid grid-cols-1 gap-4">
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div class="flex items-start">
                    <i class="fas fa-lightbulb text-blue-600 dark:text-blue-400 mt-1 mr-3"></i>
                    <div>
                        <h4 class="text-sm font-medium text-blue-900 dark:text-blue-100">Dica de Exportação</h4>
                        <p class="text-xs text-blue-700 dark:text-blue-300 mt-1">
                            Você pode exportar um workspace existente para ver a estrutura do arquivo JSON.
                        </p>
                    </div>
                </div>
            </div>
