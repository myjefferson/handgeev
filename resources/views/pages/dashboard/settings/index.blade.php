...
@section('content_dashboard')
    <div class="max-w-4xl mx-auto">        
        <div class="flex justify-between items-center">
            <h3 class="title-header text-2xl font-semibold">Settings</h3>
        </div>
            ...
            <section class="bg-slate-800 rounded-xl p-6 border border-slate-700">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-slate-900 rounded-lg p-5 border border-slate-700">
                        <label class="block text-sm font-medium text-slate-400 mb-2">Chave Global API</label>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <code class="font-mono text-teal-400 bg-slate-800 px-3 py-2 rounded-lg text-sm">
                                    {{ $settings->global_hash_api ? $settings->global_hash_api : 'Não gerado' }}
                                </code>
                            </div>
                    ...
                    <div class="bg-gradient-to-r from-teal-400/10 to-blue-400/10 rounded-lg p-5 border border-teal-400/20">
                        <h3 class="font-medium text-white mb-2">Gerar Novo Código</h3>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#generateCodeButton').click(function (e) {
                if (!confirm('Ao gerar novo código global, os antigos serão invalidados. Continuar?')) {
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            alert('Código global gerado com sucesso!');
                        } else {
