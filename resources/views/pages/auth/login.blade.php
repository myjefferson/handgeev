...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-slate-950 text-white">
        <div>
            <section>
                <div class="flex flex-col items-center justify-center px-5 py-5 mx-auto h-screen text-white">
                    <div class="flex justify-center">
                        <img class="mb-3 w-56" src="assets/images/logo.png" alt="Portfoline">
                    </div>
                    <div class="w-full sm:w-full md:w-96 bg-slate-800 rounded-lg shadow border-2 border-teal-400 md:mt-0 sm:max-w-md xl:p-0">
                        <div class="px-4 py-3 space-y-4 md:space-y-6">
                            ...
                            <form class="space-y-3 md:space-y-4" action="{{route('login.store')}}" method="POST">
                                ...
                                <div>
                                    ...
                                    <a href="#" class="text-sm text-slate-400 underline">Esqueceu a senha?</a>
                                </div>
                                ...
                                <div class="">
                                    <button type="submit" class="w-full text-slate-900 bg-teal-400 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-md px-5 py-3 text-center dark:hover:bg-primary-700 dark:focus:ring-primary-800 mt-4">Entrar</button>
                                    <a href="{{route('register.index')}}" class="block text-center w-full text-teal-400 mt-4 mb-3">Criar conta</a>
                                </div>
