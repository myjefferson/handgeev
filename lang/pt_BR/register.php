...
return [
    'title' => 'Criar conta',
    'subtitle' => 'Preencha os dados abaixo para começar sua jornada',
    ...
    'features' => [
        ...
        'instant_setup_desc' => 'Geev API automática em segundos',
    ...
    'form' => [
        'name' => 'Nome',
        'name_placeholder' => 'Ex: Maria',
        'surname' => 'Sobrenome',
        'surname_placeholder' => 'Ex: Carvalho',
        'email' => 'Email',
        'email_placeholder' => 'Digite seu melhor e-mail',
        'password' => 'Senha',
        'password_placeholder' => '••••••••',
        'password_hint' => 'Use pelo menos 8 caracteres com letras e números',
        'terms' => 'Eu concordo com os :terms e :privacy',
        'terms_link' => 'Termos',
